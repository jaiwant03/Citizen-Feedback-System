...
export default function ReportIssue() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 animate-in slide-in-from-bottom-4 duration-500 w-full">
      <div className="bg-white rounded-3xl shadow-lg shadow-indigo-100/50 border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-8 text-white text-center">
          <h2 className="text-3xl font-extrabold tracking-tight">Report a Road Issue</h2>
          <p className="mt-2 text-indigo-100 font-medium">Help us identify and fix infrastructure problems</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="px-6 md:px-10 py-8 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <select name="issueType" value={formData.issueType} onChange={handleChange} className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:bg-white transition-all outline-none">
              ...
              <option value="crack">Crack / Surface Damage</option>
          ...
          <div className="space-y-2">
            ...
            <textarea required name="description" value={formData.description} onChange={handleChange} rows="4" className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:bg-white transition-all outline-none resize-none" placeholder="Please describe the issue in detail (e.g., depth, exact position in the lane)"></textarea>
          </div>
          ...
          <div className="space-y-4">
            <label className="text-sm font-semibold text-gray-700">Location (GPS or Manual Address)</label>
            <div className="bg-gray-50 p-5 rounded-2xl border border-gray-200 flex flex-col gap-4">
          ...
          <div className="pt-6">
            <button type="submit" disabled={loading} className="w-full flex justify-center items-center py-4 px-4 rounded-xl shadow-lg shadow-indigo-200 text-lg font-bold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all transform hover:-translate-y-0.5 disabled:transform-none disabled:shadow-none disabled:opacity-70 disabled:cursor-not-allowed">
              {loading ? (
                <>
